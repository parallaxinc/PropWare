# This file sets the basic flags for the ECOGCXX language in CMake.
...
if(CMAKE_USER_MAKE_RULES_OVERRIDE_ECOGCXX)
  # Save the full path of the file so try_compile can use it.
  include(${CMAKE_USER_MAKE_RULES_OVERRIDE_ECOGCXX} RESULT_VARIABLE _override)
  set(CMAKE_USER_MAKE_RULES_OVERRIDE_ECOGCXX "${_override}")
endif()
...
if(NOT CMAKE_MODULE_EXISTS)
  set(CMAKE_SHARED_MODULE_ECOGCXX_FLAGS ${CMAKE_SHARED_LIBRARY_CXX_FLAGS})
  set(CMAKE_SHARED_MODULE_CREATE_ECOGCXX_FLAGS ${CMAKE_SHARED_LIBRARY_CREATE_CXX_FLAGS})
endif()
...
"<CMAKE_C_COMPILER> <DEFINES> ${CMAKE_ECOGCXX_FLAGS_INIT} <FLAGS> -o <OBJECT> -c <SOURCE>"
 "${CMAKE_COMMAND} -DOBJCOPY=\"${CMAKE_OBJCOPY}\" -DFILE=<OBJECT> -DVERBOSE=$(VERBOSE) -P ${PROPWARE_PATH}/CMakeModules/CMakeRunObjcopy.cmake")
